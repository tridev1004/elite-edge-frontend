export const list = [
  ...
  },
  {
    ...
    `,
    content: `Most eliteEdge products are flat-packed, making them easy to transport. The eliteEdge store offers (or will refer you to) a home delivery service if you prefer. Home delivery is not included in the product price.`,
  },
  {
    id: 4,
    heading: `Why are items sometimes out of stock?
    `,
    content: `Every effort is made to maintain the availability of items shown in the catalogue, but due to popularity and supply issues, some products may not always be available. Generally, eliteEdge can estimate when a product should be back in stock. Because eliteEdge products are manufactured throughout the world, there are sometimes circumstances which can cause delivery delays`,
  },
  {
    id: 5,
    heading: `What if I want to have the products assembled?
    `,
    content: `eliteEdge products are generally easy to assemble and require no special tools. If you prefer, most eliteEdge stores can refer you to a reputable, reasonably priced assembly company that can come to your home to assemble and install our products.`,
  },
  {
    id: 6,
  ...
  {
    id: 8,
    heading: `What is the eliteEdge business idea?
    `,
    content: `The eliteEdge business idea is: "We shall offer a wide range of well-designed, functional home furnishing products at prices so low that as many people as possible will be able to afford them."`,
  },
  {
    id: 9,
    heading: `How does eliteEdge approach environmental issues?
    `,
